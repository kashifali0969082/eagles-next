...
const eaglesTheme: Theme = {
  ...
  colors: {
    ...
    actionButtonSecondaryBackground: 'linear-gradient(90deg, rgba(31, 41, 55, 0.8), rgba(0, 0, 0, 0.8))',
    ...
    // Download cards
    downloadBottomCardBackground: 'linear-gradient(135deg, rgba(31, 41, 55, 0.95), rgba(0, 0, 0, 0.95))',
    downloadTopCardBackground: 'linear-gradient(135deg, rgba(31, 41, 55, 0.8), rgba(0, 0, 0, 0.8))',
    ...
    profileForeground: 'linear-gradient(135deg, rgba(31, 41, 55, 0.9), rgba(0, 0, 0, 0.9))',
  ...
  shadows: {
    connectButton: '0 10px 15px -3px rgba(245, 158, 11, 0.25), 0 4px 6px -2px rgba(245, 158, 11, 0.1)',
    dialog: '0 25px 50px -12px rgba(0, 0, 0, 0.5), 0 0 0 1px rgba(245, 158, 11, 0.1)',
