...
const Levelx2Enhanced: React.FC = () => {
  ...
  const activeLevel = useUserLevels.getState().lvlX2;
  ...
  const setActiveLevel = useUserLevels((state) => state.setLvlX2);
  const levels = useX2LevelStore.getState().levels;
